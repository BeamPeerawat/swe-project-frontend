    ...
    <div class="sidebar" :class="{ 'open': isOpen }">
      ...
      <div class="sidebar-content">
        <ul class="sidebar-menu">
          <li class="menu-item">
            <router-link to="/admin/dashboard" class="menu-link" active-class="active">
              <i class="fas fa-tachometer-alt"></i>
              <span>แดชบอร์ด</span>
            </router-link>
          </li>
          <li class="menu-item">
            <router-link to="/admin/announcements" class="menu-link" active-class="active">
              <i class="fas fa-bullhorn"></i>
              <span>ประชาสัมพันธ์</span>
            </router-link>
          </li>
          <li class="menu-item">
            <router-link to="/admin/courses" class="menu-link" active-class="active">
          ...
          <li class="menu-item">
            <router-link to="/admin/profile" class="menu-link" active-class="active">
