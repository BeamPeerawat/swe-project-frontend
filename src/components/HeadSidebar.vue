    ...
    <div class="sidebar" :class="{ 'open': isOpen }">
      ...
      <div class="sidebar-content">
        <ul class="sidebar-menu">
          <li class="menu-item">
            <router-link to="/head/home" class="menu-link" active-class="active">
              <i class="fas fa-home"></i>
              <span>หน้าหลัก</span>
            </router-link>
          </li>
          <li class="menu-item">
            <router-link to="/head/profile" class="menu-link" active-class="active">
        ...
        <div class="logout-section">
          <div class="user-info">
            ...
            <div class="user-details">
              ...
              <p class="user-role">หัวหน้าสาขาวิชา</p>
            </div>
          </div>
